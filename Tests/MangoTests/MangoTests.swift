...
final class MangoTests: XCTestCase {
    ...
    func testUnRespondableItem() throws {
        ...
        XCTAssert(
            childAccessibleElement.mangoShot().isEmpty,
    ...
    func testStandardUIKitControls() throws {
        ...
        // When
        let axSnapshot = containerView.mangoShot()
